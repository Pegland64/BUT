...
public class LectureFichier {
     ...
     */
    public String[] lireFichier() throws ErreurLectureException {
        File f = new File(nom);
        FileReader fr = null;
        ...
        try {
            ...
            throw new ErreurLectureException("Fichier "+nom+" inexistant");
        }
        ...
        try {
            ...
            throw new ErreurLectureException("Erreur I/O de lecture du Fichier "+nom);
        }
